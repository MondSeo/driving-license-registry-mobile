...
//
    ...
    public static boolean setVehicleRegistrationImage(Context context, String frontImage, String backImage) {
//        PreferenceUtil pref = PreferenceUtil.getInstance(context);
//        String selectedDrivingLicenseIndex = pref.getPreference(PrefKeys.KEY_DRIVING_LICENSE_INDEX);
//
        return BluelinkModel.getInst(context).insertVehicleRegistrationImageTable(frontImage, backImage);
