...
import com.example.mylicenseregistry.datadto.GenesisSettings;


public class GenesisDatabaseHelper extends SQLiteOpenHelper {

	private final String TAG = "GenesisDatabaseHelper";
	...
	private static final String DATABASE_NAME = "genesis2021c.db";
	...
	public GenesisDatabaseHelper(Context context) {
    ...
    private String getUserPhotoCreateQuery()
    {
        ...
        sb.append( " ('userId' TEXT PRIMARY KEY ,");
        sb.append( " '"+ GenesisSettings.UserInfo.USER_PHOTO +"' TEXT DEFAULT NULL,");
        sb.append( " '"+ GenesisSettings.UserInfo.USER_PHOTO_CPW +"' TEXT DEFAULT NULL );");
        return sb.toString();
    }
