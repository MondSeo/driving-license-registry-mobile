...
public class GenesisModel
{
    ...
    private static GenesisModel mGenesisModel;

    public static synchronized GenesisModel getInst(Context context)
    {
        if (mGenesisModel == null)
        {
            if (context != null)
            {
                mGenesisModel = new GenesisModel(context);
            }
            else
            {
                return null;
        ...
        return mGenesisModel;
    }

    public GenesisModel(Context context)
    {
        SQLiteOpenHelper mOpenHelper = new GenesisDatabaseHelper(context);
...
//            errorLogcat("selectUserPhotoTable 실패",e);
    ...
    private void errorLogcat(String msg,Exception e)
    {
        LogUtils.errorLogcat(getClass().getSimpleName(),msg,e);
    }
