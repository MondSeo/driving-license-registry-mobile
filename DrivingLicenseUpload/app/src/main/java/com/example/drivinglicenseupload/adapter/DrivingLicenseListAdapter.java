...
public class DrivingLicenseListAdapter extends RecyclerView.Adapter {
    ...
    public static class DrivingLicenseListViewHolder extends RecyclerView.ViewHolder {
        ...
        public DrivingLicenseListViewHolder(@NonNull View itemView) {
            ...
            uploadedDrivingLicenseFrontImage = itemView.findViewById(R.id.img_DrivingLicenseRegisterActivity_UploadedImage_Front);
            uploadedDrivingLicenseBackImage = itemView.findViewById(R.id.img_DrivingLicenseRegisterActivity_UploadedImage_Back);
